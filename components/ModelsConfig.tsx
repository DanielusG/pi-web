    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <button onClick={onDelete}
          style={{ padding: "3px 8px", background: "none", border: "1px solid color-mix(in srgb, var(--danger) 30%, transparent)", borderRadius: 5, color: "var(--danger)", cursor: "pointer", fontSize: 11 }}>
           {t("i18n.delete")}
        </button>
      </div>
       ...
       <Field label={t("i18n.providerName")}>
        ...
        {editingName !== name && editingName.trim() && (
          <button onClick={() => onRename(editingName.trim())}
            style={{ marginTop: 4, padding: "3px 10px", background: "var(--accent)", border: "none", borderRadius: 5, color: "#fff", cursor: "pointer", fontSize: 11, alignSelf: "flex-start" }}>
             {t("i18n.rename")}
          </button>
        )}
      </Field>
      ...
      <div style={{ borderTop: "1px solid var(--border)", paddingTop: 14, display: "flex", flexDirection: "column", gap: 10 }}>
        {discoveryState.phase !== "success" && (
          <button
            ...
            style={{
              alignSelf: "flex-start", height: 30, padding: "0 12px", border: "1px solid var(--border)", borderRadius: 7,
        ...
        {discoveryState.phase === "error" && (
          <div style={{ padding: "7px 9px", border: "1px solid color-mix(in srgb, var(--danger) 30%, transparent)", borderRadius: 7, color: "var(--danger)", fontSize: 11, lineHeight: 1.4 }}>
        ...
        {discoveryState.phase === "success" && (
          <>
            ...
            <div style={{ maxHeight: 220, overflowY: "auto", border: "1px solid var(--border)", borderRadius: 8, background: "var(--bg-panel)" }}>
              <label
                style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
              ...
              <button
                ...
                style={{ height: 28, padding: "0 11px", border: "none", borderRadius: 7, background: selectedCount ? "var(--accent)" : "var(--bg-panel)", color: selectedCount ? "#fff" : "var(--text-dim)", cursor: selectedCount ? "pointer" : "not-allowed", fontSize: 11, fontWeight: 600, whiteSpace: "nowrap" }}
              >
                {selectedCount
      ...
      {THINKING_LEVELS.map((level) => {
        ...
        return (
          ...
          >
            ...
            <div style={{ display: "flex", borderRadius: 7, border: `1px solid ${state === "string" ? "var(--accent)" : "var(--border)"}`, overflow: "hidden", transition: "border-color 0.1s" }}>
              <button
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      <button onClick={() => setRows((current) => [
        ...
        style={{ padding: "5px 9px", background: "none", border: "1px solid var(--border)", borderRadius: 5, color: "var(--text-muted)", cursor: "pointer", fontSize: 11, display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 5, alignSelf: "flex-start" }}>
        + Add header
      </button>
    </div>
  );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button onClick={onDelete}
            style={{ height: 24, padding: "0 8px", background: "none", border: "1px solid color-mix(in srgb, var(--danger) 30%, transparent)", borderRadius: 5, color: "var(--danger)", cursor: "pointer", fontSize: 11, boxSizing: "border-box" }}>
             {t("i18n.remove")}
          </button>
        </div>
      </div>
      ...
      <div style={{ padding: "2px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <button
            ...
            style={{
              height: 28, padding: "0 10px", border: "1px solid var(--border)", borderRadius: 7,
              background: "var(--bg-panel)",
      ...
      <div style={{ minHeight: 48 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {loginState.options.map((option) => (
                <button
                  ...
                  style={{ padding: "6px 9px", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 7, color: "var(--text)", cursor: "pointer", fontSize: 12, textAlign: "left" }}
                >
                  {option.label}
                </button>
              ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              <input
                ...
                style={{ flex: 1, padding: "6px 9px", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 7, color: "var(--text)", fontSize: 12, outline: "none", fontFamily: "var(--font-mono)", boxSizing: "border-box" }}
              />
              <button
                onClick={() => submitCode(loginState.token, inputValue)}
                disabled={!inputValue.trim()}
                style={{ padding: "6px 12px", background: inputValue.trim() ? "var(--accent)" : "var(--bg-panel)", border: "none", borderRadius: 7, color: inputValue.trim() ? "#fff" : "var(--text-dim)", cursor: inputValue.trim() ? "pointer" : "not-allowed", fontSize: 12, fontWeight: 600, flexShrink: 0 }}
              >
                 {t("i18n.submit")}
              </button>
            </div>
        ...
        {loginState.phase === "device_code" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ padding: "8px 10px", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 7, color: "var(--text)", fontSize: 16, fontWeight: 700, fontFamily: "var(--font-mono)", letterSpacing: 0 }}>
              {loginState.userCode}
            </div>
            <p style={{ margin: 0, fontSize: 11, color: "var(--text-dim)", lineHeight: 1.5 }}>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        {isWorking ? (
          <button
            ...
            style={{ padding: "5px 12px", background: "none", border: "1px solid var(--border)", borderRadius: 7, color: "var(--text-muted)", cursor: "pointer", fontSize: 12 }}
          >
             {t("i18n.cancel")}
          </button>
        ) : (
          <>
            <button
              onClick={handleLogin}
              style={{ padding: "5px 14px", background: "var(--accent)", border: "none", borderRadius: 7, color: "#fff", cursor: "pointer", fontSize: 12, fontWeight: 600 }}
            >
            ...
            {provider.loggedIn && (
              <button
                ...
                style={{ padding: "5px 12px", background: "none", border: "1px solid color-mix(in srgb, var(--danger) 30%, transparent)", borderRadius: 7, color: "var(--danger)", cursor: "pointer", fontSize: 12 }}
              >
                 {t("i18n.disconnect")}
              </button>
            )}
      ...
      {provider.configured && (
        <button
          ...
          style={{
            ...
            borderRadius: 7, color: "var(--danger)",
...
function AddProviderPicker({
  ...
  return (
    ...
    >
      <div style={{ width: 820, maxWidth: "calc(100vw - 32px)", maxHeight: "min(72vh, calc(100vh - 32px))", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 12, display: "flex", flexDirection: "column", boxShadow: "var(--shadow-lg)", overflow: "hidden" }}>
        {/* Search */}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(240px, 100%), 1fr))", gap: 8 }}>
              ...
              {showCustom && (
                ...
                >
                  ...
                  <span style={{ width: 26, height: 26, borderRadius: 7, background: "var(--bg-hover)", border: "1px dashed var(--border)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
...
export function ModelsConfig({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(0,0,0,0.35)", display: "flex", alignItems: "center", justifyContent: "center" }}
      onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div style={{ width: isMobile ? "calc(100vw - 16px)" : 860, maxWidth: "calc(100vw - 16px)", height: isMobile ? "calc(100dvh - 16px)" : "78vh", maxHeight: "calc(100dvh - 16px)", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 12, display: "flex", flexDirection: "column", boxShadow: "var(--shadow-lg)", overflow: "hidden" }}>
          ...
          <div style={{
              ...
              {activeOAuth.map((p) => {
                ...
                return (
                  <div
                    ...
                    style={{ display: "flex", alignItems: "center", gap: 7, padding: "5px 8px", borderRadius: 7, cursor: "pointer", background: isSelected ? "var(--bg-selected)" : "none" }}
                ...
                return (
                  <div key={pName} style={{ marginBottom: 2 }}>
                    ...
                    <div
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 8px", borderRadius: 7, cursor: "pointer", background: isProviderSelected ? "var(--bg-selected)" : "none" }}
                    ...
                    {models.map((m, i) => {
                      ...
                      return (
                        <div
                          ...
                          style={{ display: "flex", alignItems: "center", gap: 6, padding: "5px 8px 5px 26px", borderRadius: 7, cursor: "pointer", background: isModelSelected ? "var(--bg-selected)" : "none" }}
                        ...
                        >
                          ...
                          {m.reasoning && (
                            <span style={{ fontSize: 9, padding: "1px 4px", background: "rgba(99,102,241,0.12)", color: "rgba(99,102,241,0.8)", borderRadius: 5, flexShrink: 0 }}>T</span>
                          )}
                        </div>
                      );
                    })}
                    ...
                    <div
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 4, padding: "4px 8px 4px 26px", borderRadius: 7, cursor: "pointer", color: "var(--text-dim)" }}
            ...
            <div style={{ borderTop: "1px solid var(--border)", padding: "8px 6px" }}>
              <button onClick={() => setPickerOpen(true)} style={{
                ...
                width: "100%", padding: "6px 0", background: "none", border: "1px dashed var(--border)", borderRadius: 7,
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 10, padding: "10px 18px", borderTop: "1px solid var(--border)", flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{ padding: "6px 14px", background: "none", border: "1px solid var(--border)", borderRadius: 8, color: "var(--text-muted)", cursor: "pointer", fontSize: 13 }}>
             {t("i18n.cancel")}
          </button>
